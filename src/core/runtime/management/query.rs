...
//! Membership comes from the registry. Physical activity combines registry activity bits with
//! force-aborted attempts that remain active after membership ends.
